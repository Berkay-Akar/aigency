...
const REGISTRY: Record<GenerationMode, Record<ModelTier, string>> = {
  ...
  "image-to-image": {
    fast: "fal-ai/gemini-25-flash-image/edit",
    standard: "fal-ai/gemini-3.1-flash-image-preview/edit",
    premium: "fal-ai/flux-pro/kontext/max/multi",
  },
  "image-to-video": {
...
export function listModelsByMode(): Record<GenerationMode, readonly string[]> {
  return {
